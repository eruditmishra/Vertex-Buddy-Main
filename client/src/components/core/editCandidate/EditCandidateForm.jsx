...
const EditCandidateForm = () => {
    ...
    if (response?.success) {
      setCandidateData({
        ...
        name: `${response.data.firstName} ${
          response.data.middlename ? response.data.middlename : ""
  ...
  const editCandidateHandler = async (event) => {
    ...
    if (response?.success) {
      ...
      window.location.pathname.includes("admin")
        ...
        : navigate(`/user/candidates/candidate/${candidateId}`);
      resetForm();
    }
  };
  ...
  return (
    ...
    >
      ...
      <div className="w-fit mx-auto">
        <CTAButton title={"Update Candidate"} />
      </div>
    </form>
  );
};
