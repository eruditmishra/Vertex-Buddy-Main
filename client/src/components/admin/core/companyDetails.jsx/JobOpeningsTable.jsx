...
import { getJobsOfACompany } from "../../../../services/operations/jobAPI";
...
const JobOpeningsTable = ({ company }) => {
  ...
  const fetchJobs = async () => {
    const response = await getJobsOfACompany(company?._id, token);
  ...
  useEffect(() => {
    company && company?.jobs?.length >= 1 && fetchJobs();
  }, [company]);
